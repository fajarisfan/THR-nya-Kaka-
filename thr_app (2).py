...
.copy-btn:hover { background: #66bb6a; transform: translateY(-1px); }
...
.copy-btn-zizah:hover { background: #9333ea; transform: translateY(-1px); }
...
if is_zizah:
    ...
    <div class="zizah-card">
        ...
        <strong>tap tombol di bawah, nomor DANA gua langsung ke-copy.</strong>
    ...
    <div class="wrap">
        ...
        <div class="num" id="num" onclick="copyNum()">{DANA_NUMBER}</div><br>
